######
# esse arquivo foi usado para efeito de estudo, e futuras consultas
# exemplos caso deseja utilizar uma url por APP o que e recomendado
# para esse projeto sera mantido o default que e um url na pasta do
#projeto_estoque
######
